...
- [x] **Stage Selector** - Exécution modules individuels avec validation ✅
- [x] **Config Override** - Surcharge parameters via CLI ✅
- [x] **Kill Switch** - Arrêt d'urgence propre avec état sauvegardé ✅
