...
// EN: PipelineEngineImpl constructor and destructor implementations
// FR: Implémentations du constructeur et destructeur de PipelineEngineImpl

PipelineEngine::PipelineEngineImpl::PipelineEngineImpl(const Config& config)
    : config_(config)
...
PipelineEngine::PipelineEngineImpl::~PipelineEngineImpl() {
    shutdown();
}
